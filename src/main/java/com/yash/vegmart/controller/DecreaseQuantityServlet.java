...
/**
 * Servlet controller for decreasing quantity of cart items in the VegMart system.
 * Processes HTTP POST requests from AJAX cart updates to decrement item quantity (minimum 1),
 * updates session cart, and returns JSON-like response with updated values for frontend.
 *
 * Mapped to URL: /DecreaseQuantity
...
public class DecreaseQuantityServlet extends HttpServlet {
    ...
    /**
     * Handles HTTP POST requests to decrease cart item quantity by 1 (minimum quantity = 1).
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Decrease quantity only if greater than 1 (prevent zero quantity)
